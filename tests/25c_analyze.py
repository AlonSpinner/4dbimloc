...
rbpf_0_cross_entropy, _ = cross_entropy_error(ground_truth_beliefs,
                                           results[0]['expected_belief_map'])
rbpf_1_cross_entropy, _ = cross_entropy_error(ground_truth_beliefs,
                                           results[1]['expected_belief_map'])
rbpf_2_cross_entropy, _ = cross_entropy_error(ground_truth_beliefs,
...
rbpf_0_map_entropy, _ = map_entropy(results[0]['expected_belief_map'])
rbpf_1_map_entropy, _ = map_entropy(results[1]['expected_belief_map'])
rbpf_2_map_entropy, _ = map_entropy(results[2]['expected_belief_map'])
